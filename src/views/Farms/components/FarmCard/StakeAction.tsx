...
const StakeAction: React.FC<FarmCardActionsProps> = ({ stakedBalance, tokenBalance, tokenName, pid, depositFeeBP, myStakedValue }) => {
  ...
  return (
    <Flex justifyContent="space-between" alignItems="center">
      ...
      <Row>
        <Text fontSize="10px" color={rawStakedBalance === 0 ? 'textDisabled' : 'text'}>
          {myStakedValue}
        </Text>
      </Row>
      </div>
