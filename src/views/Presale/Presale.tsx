...
const Presale: React.FC = () => {
    ...
    const [countdownDate, setCountdownDate] = useState(1627671082000)
                    ...
                    <Card className={styles.card}>
                        ...
                        <CardFooter>
                            <div className={styles.flex}>
                                ...
                                <div className={styles.item}>BUFF left: <span className={styles.colored}>{getBalanceNumber(presale.tokensLeft)}</span></div>
                                <div className={styles.item}>Presale Price: $0.01</div>
                                <div className={styles.item}>Launch Price: $0.01</div>
                            </div>
                        </CardFooter>
                    </Card>
                    <Card className={styles.card}>
                        <CardBody>Your BUFF Stats</CardBody>
                        <CardFooter>{!account ? <UnlockButton mt="8px" fullWidth /> :
                            <div className={styles.flex}>
                                <div className={styles.item}>BUFF you have unclaimed: <span className={styles.colored}>{getBalanceNumber(presale.tokensUnclaimed)}</span></div>
                                <div className={styles.item}>BUFF you have in wallet: <span className={styles.colored}>{getBalanceNumber(presale.cakeBalance)}</span></div>
                            </div>
                        }</CardFooter>
                    </Card>
                </Flex>
